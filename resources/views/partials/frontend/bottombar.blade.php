<nav class="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 w-auto max-w-full px-4">
    ...
    <div class="p-2 rounded-3xl backdrop-blur-xl flex items-center gap-2 transition-colors duration-300 shadow-2xl
                bg-white/80 border border-gray-200
                dark:bg-[#0a0a0a]/90 dark:border-white/15 dark:shadow-[0_0_20px_rgba(0,0,0,0.5)]">
        ...
        <button @click="switchTab('home')"
                ...
                :class="activeTab === 'home'
                    ? 'w-28 bg-gray-100 text-rail-accent shadow-sm dark:bg-white/15 dark:text-rail-accent dark:shadow-none'
                    : 'w-12 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/10 dark:hover:text-white'">
        ...
        <button @click="switchTab('dashboard')"
                ...
                :class="activeTab === 'dashboard'
                    ? 'w-32 bg-gray-100 text-rail-accent shadow-sm dark:bg-white/15 dark:text-rail-accent dark:shadow-none'
                    : 'w-12 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/10 dark:hover:text-white'">
