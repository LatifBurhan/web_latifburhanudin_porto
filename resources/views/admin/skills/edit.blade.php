...
@section('content')
    <div class="p-6 max-w-2xl mx-auto">
        <div class="flex items-center gap-4 mb-6">
            ...
            <h2 class="text-2xl font-bold text-white">Edit Skill</h2>
        </div>
            ...
            <form action="{{ route('admin.skills.update', $skill->id) }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="cursor-pointer">
                            <input type="radio" name="category" value="tech" class="peer sr-only"
                                {{ $skill->category == 'tech' ? 'checked' : '' }}>
                            <div
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-4">
                        <input type="color" name="color" value="{{ $skill->color }}"
                ...
                <button type="submit"
                    class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-blue-500/30">
                    Update Skill
                </button>
            </form>
        </div>
