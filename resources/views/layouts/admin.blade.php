        ...
        <aside class="w-64 bg-rail-card border-r border-white/5 p-6 hidden md:flex flex-col fixed h-full z-50">
            ...
            <nav class="space-y-2 flex-1">
                ...
                <a href="{{ route('admin.resumes.index') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 {{ request()->routeIs('admin.resumes.*') ? 'bg-rail-accent text-white shadow-lg shadow-purple-900/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
